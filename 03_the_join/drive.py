"""Rung 03 driver — 02's drive() plus THE JOIN.

Commands: reset | start | approve | status | pending

The join is four lines of code in ring(): after every machine doorbell,
count qc-passed jobs IN THE WORLD (the order book, not the chat) and print
the meter. The model narrates the finish; the driver verifies it.
"""
import asyncio
import os
import sys
