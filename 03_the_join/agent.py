...
One request fans out into FOUR long jobs (trailer, poster, music,
localized_trailer). The agent holds several pending calls at once; the world
finishes them in its own order; the driver counts completions — the join
lives in drive.py's ring(), not in the model's head.
"""
import os
